...
TensorRTRTX or Pywinrt Registration Failure (Python)
=====================================================
...
Run pywinrt-related code in a **separate process**. Use the subprocess pattern shown in :doc:`winml_ep` (place ``winml.py`` in the same directory as your application script).
