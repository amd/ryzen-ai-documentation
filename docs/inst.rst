...
- Download the RyzenAI Software installer :download:`ryzen-ai-1.6.0.msi <https://account.amd.com/en/forms/downloads/ryzen-ai-software-platform-xef.html?filename=ryzen-ai-lt-1.6.0-GA.exe>`.
